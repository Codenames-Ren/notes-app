...
export default function Navbar() {
  ...
  return (
    <nav className="bg-yellow-400 dark:bg-gray-900 dark:shadow-cyan-400 dark:border-gray-800 border-b-4 border-black shadow-[8px_8px_0px_black] p-4">
      <div className="flex justify-between items-center relative">
        ...
        <div
          className={`${
            isOpen ? "flex" : "hidden"
          } flex-col md:flex md:flex-row md:items-center fixed md:static left-0 right-0 top-[72px] w-full bg-yellow-400 dark:bg-gray-900 md:w-auto md:bg-transparent dark:md:bg-transparent transition-all duration-300 ease-in-out z-50`}
        >
