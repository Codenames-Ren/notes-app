...
export default function Navbar() {
  ...
  return (
    <nav className="bg-yellow-400 dark:bg-gray-900 dark:border-gray-800 border-b-4 border-black shadow-[8px_8px_0px_black] p-4">
      <div className="flex justify-between items-center">
        <Link
          href="#"
          className="text-xl font-extrabold text-white  dark:text-white tracking-wider"
        >
          NotesApp
        </Link>
        ...
        {/* Menu Items */}
        <div
          className={`flex-col md:flex md:flex-row md:items-center md:gap-8 mx-6 transition-all duration-300 ease-in-out ${
            isOpen ? "flex" : "hidden"
          }`}
        >
          {/* Dekstop Dark Mode */}
